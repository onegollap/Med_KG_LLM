...
tokenizer = AutoTokenizer.from_pretrained("RAGOnMedicalKG/model", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("RAGOnMedicalKG/model", trust_remote_code=True).cuda()
model = model.to(device)
model.generation_config = GenerationConfig.from_pretrained("RAGOnMedicalKG/model")
